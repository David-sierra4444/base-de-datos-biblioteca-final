...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2026 a las 02:47:08
...
(13, 'harold', 'rolberto', 'Calle 14', '95342321');
...
--
ALTER TABLE `tbl_tipoautores`
  ADD CONSTRAINT `fk_tipoautores_autor` FOREIGN KEY (`copiaAutor`) REFERENCES `tbl_autor` (`aut_codigo`),
  ADD CONSTRAINT `fk_tipoautores_libro` FOREIGN KEY (`copiaISBN`) REFERENCES `tbl_libro` (`lib_isbn`);
COMMIT;
